...
public class LoanAppBean {
	...
	private double remaingingAmt;
	private String loanEndDate;
	private String last_paid_installment;
	public String getLast_paid_installment() {
		return last_paid_installment;
	}
	public void setLast_paid_installment(String last_paid_installment) {
		this.last_paid_installment = last_paid_installment;
	}
	...
	public double getRemaingingAmt() {
		return remaingingAmt;
	}
	public void setRemaingingAmt(double remaingingAmt) {
		this.remaingingAmt = remaingingAmt;
	}
