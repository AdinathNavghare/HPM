			...
			<tr class="alt">
				...
				<table align="center">
					...
					<tr>
						...
						<option value="A">Age Wise</option>
						<option value="D">Designation Wise</option>						
						<option value="DEPT">Department Wise</option>
						<option value="P">Project List Wise</option>
						<option value="G">Grade Wise</option>
						<option value="J">Date Of Joining Wise</option>
						<option value="L">Date Of Leaving Wise</option>
						<option value="C">Employee List Wise</option>
