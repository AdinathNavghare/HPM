...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<tr class="alt">
				...
				<table align="center">
					<tr class="alt" height="30" align="center">
                     <input type="hidden" id="action" name="action" value="CTCChange"></input>
						<!-- <td>Select Date</td>
						<td align="left">
            ...
            <td><input  name="date1" id="dob" type="text" value=" " readonly="readonly">
             &nbsp;<img src="images/cal.gif" style="vertical-align: middle; cursor: pointer;"
				onClick="javascript:NewCssCal('dob', 'ddmmmyyyy')" />			</td>
					...
					<tr>
						<td >Employee Type</td><td  align="left">
						<select id="empType" name="empType" WIDTH="50">
					...
					<tr>
						<td >Report Type</td><td  align="left">
						<select id="type" name="type" WIDTH="50">
						<!--<option value="0">Select</option>		-->
