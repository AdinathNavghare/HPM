...
else
{
	...
	function ViewReport1()
	{
		...
		//var btn = document.getElementById("button").value;
		   ...
		   url="ReportServlet?action=sitewisepayreg&date="+date+"&pp="+prjCode;
...
<body style="overflow:hidden;"> 
 <%
	String pageName = "SiteWisePayReg.jsp";
 String prjCode = "";
	try
	{
					...
					<tr class="alt">
						...
						<td bgcolor="#FFFFFF">
						 ...
						 <input name="date" id="date" readonly="readonly" class="date-picker" placeholder="Click here for Calender"/>
															...
															<td  align="center">Project Code : <select style="width:400px"
																name="prjCode" id="prjCode" >
																	<option value="select" selected>Select</option>
																	<%
    																ArrayList<EmpOffBean> list= new ArrayList<EmpOffBean>();
																	EmpOffHandler ofh = new EmpOffHandler();
    						 										list=ofh.getActiveprojectCode();
    						 										int p;
