...
<title>Payroll Calculation &copy DTS3</title>
...
function getEmpToFinalize()
{
	...
	{
		getFilter('empToFinalise',month);
	}
}

function EmpNotFinalise(){
	
	window.location.href ="EmpNotFinalise.jsp";
}
		...
		<div id="content-table-inner">
			...
			<!-- <form  name="leaveLedgerform" action="CoreServlet"  method="post" onSubmit="return validate()"> -->
				...
				<table id="customers" width="553" align="center">
				   ...
				   <tr> <th>Payroll Calculation</th></tr>
					 ...
					 <tr class="alt" align="center">
						<td>
							...
							<input type="button" value="Select Employees" onclick="getFilt('toPayCal')">
							<!-- <input type="button" value="Add More Employee" onclick="addFilt('toPayCal')"> -->
							<input type="button" value="Employee Not Finalize" onclick="EmpNotFinalise()">
							<!-- <input type="button" value="Employee to be Finalize" onclick="getEmpToFinalize()">-->						</td>
					</tr>
					
					<tr class="alt">
						<td  align="center"> 
							<input type="button" value="Calculate" onclick="paycal()"/> &nbsp;&nbsp;
		   ...
		   <center>
			...
			<div id="process"  style="z-index: 1000;background-color:white;height: 100%;width: 100%;top: 0px;left: 0px;position: fixed;opacity:0.8;" hidden=true; >
				...
				<h1> Calculation takes 5 to 10 Min....Be Patience</h1>
