...
<title>Electronic Challan Cum Return (ECR)</title>
...
<%
	String pageName = "ECR_Report.jsp";
	try
	{
...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<form name="form10" action="ReportServlet"  onsubmit="return  validate()">
				<table border="1" id="customers">
					<tr>
						<th>Electronic Challan Cum Return (ECR)</th>
					<tr>
					<tr class="alt">
						<td height="80" align="center">
							<table>
								<tr class="alt">
									...
									<input type="hidden" id="action" name="action" value="ecr"></input></td>
								</tr>
								<tr>
									<td>Select Format</td>
									<td ><input type="radio" name="reporttype" value="pdffile" checked="checked">&nbsp;Pdf File
										&nbsp;&nbsp;&nbsp;<input type="radio" name="reporttype" value="excelfile" >&nbsp;Excel File</td>
								</tr>					 
								<tr>
									<td align="center">
							...
							<td  align="center">
							<input type="submit" name="after"
							value="After Finalize" />
