...
<title>&copy Attendance Report </title>
...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<form name="emplistForm" action="ReportServlet?action=newAttendSheet" method ="post" onsubmit="return validation()">
			<table border="1" id="customers" align="center">
			<tr>
				<th width="300">Attendance Report</th>
			<tr>
			<tr class="alt">
				...
				<!-- 	<tr>
						...
						<option value="ID" >Attendance</option>
