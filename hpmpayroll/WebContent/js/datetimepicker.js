...
var EndYear = 70; // The last year of pickable date. if current year is 2011, the last year that still picker will be 2016 (2011+5)
...
var WeekHeadColor = "#a41c2b"; //var WeekHeadColor="#18861B";//Background Color in Week header.
...
function RenderCssCal(bNewCal)
{
	...
	{
	    vCalHeader += "<td align='center'><select id='datemonthdisable' name='MonthSelector'  onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'>";
		for (i = 0; i < 12; i += 1)
		{
			if (i === Cal.Month)
			{
		...
		vCalHeader += "<td align='center'><select id='dateyrdisable' name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
