...
var xpos = 45; // mouse x position
var ypos = 2; // mouse y position
...
function RenderCssCal(bNewCal)
{
	...
	if (!winCal)
	{
		...
		span.style.left = (xpos + CalPosOffsetX) + '%';
		span.style.top = (ypos - CalPosOffsetY) + '%';
	...
	else
	{
		...
		if (bNewCal === true)
		{
			winCal.style.left = (xpos + CalPosOffsetX) + '%';
			winCal.style.top = (ypos - CalPosOffsetY) + '%';
		}
	}
